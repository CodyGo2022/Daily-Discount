...
function Body() {
  return (
    <>
      <div className='h-full flex items-center sm:items-start px-3 mb-16 md:px-3 3xl:px-10'>
        <div className="grid grid-rows-2 grid-flow-col gap-2 w-full sm:grid-flow-row order-3 md:grid-flow-row order-3">
          {/* Heroes & Skins */}
